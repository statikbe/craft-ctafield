...
class MigrateStatikCtaField extends PluginFieldMigration
{
    // Properties
    // =========================================================================
    ...
    public function processFieldSettings(): void
    {
        ...
        foreach ($this->fields as $field) {
            ...
            $allowClass = $settings['allowClass'] ?? true;
            ...
            foreach (($settings['allowedLinkNames'] ?? []) as $key => $type) {
                ...
                $fieldLayout = self::getDefaultFieldLayout($allowCustomText, $enableTitle, $enableAriaLabel, $allowClass);
